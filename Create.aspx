...
<body background="Images/Login-Info2.jpg">
    ...
    <p>
        <strong style="color: #00FFFF; font-weight: bold; font-size: xx-large;">Creation Home</strong></p>
    <div style="height: 288px">
        ...
        <br />
        <br />
        <asp:Button ID="BtnCourse" runat="server" ForeColor="Black" Text="Add a Course" 
            Width="139px" />
        ...
        <asp:Button ID="BtnDept" runat="server" ForeColor="Black" 
            Text="Add a Department" Width="139px" />
        <asp:DropDownList ID="ListCourse" runat="server" 
            
            style="z-index: 1; left: 460px; top: 310px; position: absolute; height: 28px; bottom: 103px; width:78px; right: 477px;" 
            Visible="False">
        ...
        <asp:DropDownList ID="ListDept" runat="server" 
            ...
            style="z-index: 1; left: 460px; top: 380px; position: absolute; height: 28px; bottom: 103px; width:78px; right: 477px;" 
            Visible="False">
            <asp:ListItem>btcs</asp:ListItem>
            <asp:ListItem>btme</asp:ListItem>
            <asp:ListItem>btit</asp:ListItem>
            <asp:ListItem>btec</asp:ListItem>
            <asp:ListItem>btee</asp:ListItem>
        </asp:DropDownList>
         <asp:DropDownList ID="ListYr" runat="server" 
            
            
            style="z-index: 1; left: 460px; top: 450px; position: absolute; height: 28px; bottom: 103px; width:78px; right: 477px;" 
            Visible="False">
            <asp:ListItem>1year</asp:ListItem>
             <asp:ListItem>2year</asp:ListItem>
             <asp:ListItem>3year</asp:ListItem>
             <asp:ListItem>4year</asp:ListItem>
        </asp:DropDownList>
        <br />
        <br />
        <br />
        <br />
        <asp:Button ID="BtnSub" runat="server" ForeColor="Black" Text="Add a Subject" 
            Width="139px" />
        <br />
        <br />
    </div>
